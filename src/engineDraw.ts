...
export const screenToWorld = (screenPos: any) => screenPos.add(vec2(.5)).subtract(mainCanvasSize.scale(.5)).multiply(vec2(1 / cameraScale, -1 / cameraScale)).add(cameraPos);
...
export const worldToScreen = (worldPos: any) => worldPos.subtract(cameraPos).multiply(vec2(cameraScale, -cameraScale)).add(mainCanvasSize.scale(.5)).subtract(vec2(.5));
 ...
 *  @param {Number}  [angle=0]
 *  @memberof Draw */
export function drawRect(pos: any, size: any, color: any, angle: any) {
...
export function drawTileScreenSpace(pos: any, size = vec2(1), tileIndex: any, tileSize: any, color: any, angle: any, mirror: any, additiveColor: any) {
 ...
 *  @param {Number}  [angle=0]
 *  @memberof Draw */
export function drawRectScreenSpace(pos: any, size: any, color: any, angle: any) {
 ...
 *  @param {Color}   [color=new Color(1,1,1)]
 *  @memberof Draw */
export function drawLine(posA: any, posB: any, thickness = .1, color: any) {
 ...
 *  @memberof Draw */
export function drawCanvas2D(pos: any, size: any, angle: any, mirror: any, drawFunction: any, context = mainContext) {
 ...
 *  @memberof Draw */
export function setBlendMode(additive: any) {
    if (glEnable)
